...
<<<<<<< HEAD:app/pipe_A.py
        ...
        viz_fpr, viz_tpr, viz_auc = roc_calc_viz(model, x_test, y_test)
=======
...
<<<<<<< HEAD:app/pipe_A.py
        ...
        log.debug(f'Process RSLocalOutlierFactor')
...
def process_A(test_percentage):
    ...
    df.to_csv(f'results/results_v4_v5_marcos/A_thrombosis_non_thrombosis_v5_{test_percentage}.csv', index=False)
    ...
    log.info('-' * 30)
    df_describe.to_csv(f'results/results_v4_v5_marcos/A_thrombosis_non_thrombosis_v5_{test_percentage}_describe.csv', index=False)
