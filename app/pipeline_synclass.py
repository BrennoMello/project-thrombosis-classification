...
def run_experiment(x, y, iterations, p, dsetname) -> pd.DataFrame:
    ...
    for i in tqdm(range(iterations)):
        ...
        results_iter = SynClass(x_train_raw, y_train_raw, x_test_raw, y_test_raw, learner = RSDT_synclass , scoring = 'f1_macro', 
                                classThreshold = 0.5, probability = False, rangeThreshold = [-0.1, 0.71, 0.01], results = final_results)
