...
def process_B(test_percentage):
    ...
    df.to_csv(f'results/results_v4_v5_marcos/B_type_I_PE_vs_Type_II_v4_{test_percentage}.csv', index=False)
    ...
    log.info('-' * 30)
    df_describe.to_csv(f'results/results_v4_v5_marcos/B_type_I_PE_vs_Type_II_v4_{test_percentage}_describe.csv', index=False)
