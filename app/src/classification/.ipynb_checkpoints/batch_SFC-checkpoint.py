...
from sfc_checkpoint import *

datasets = ['/home/brenno/Documentos/thrombosis/data/thrombosis_non_thrombosis_v4.csv'
...
for ds in datasets:
    ...
    #    print(f'Analyzing the dataset:{ds} using threshold {t}')
        ...
        acc, f1, n_inst, auc = runSFC(biodata, nrepetitions = rep, 
                                      testSize_smaller_class = testSize_smaller, positive=pos_lab)
